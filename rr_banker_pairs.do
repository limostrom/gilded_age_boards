...
if `fullset' == 0 {
	...
	*Identify bankers ever on a RR board 1880-1920
...
forval ystart = 1895(5)1915 {
	...
	*%%Generate Actual Dataset%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	if `fullset' == 1 save "rr_banker_pairs_fullset_`ystart'-`y5'.dta", replace
	else save "rr_banker_pairs_`ystart'-`y5'.dta", replace
}